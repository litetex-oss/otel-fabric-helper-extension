...
Before releasing:
* Consider doing a [test-deployment](https://github.com/litetex-oss/otel-fabric-helper-extension/actions/workflows/test-deploy.yml?query=branch%3Adev) before actually releasing.
